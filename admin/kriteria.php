...
?>
	...
	<?php } ?>
		...
		<tfoot class="full-width">
			<tr>
				<th colspan="3">
					<a href="tambah.php?jenis=kriteria" class="btn btn-primary"><i class="plus icon"></i>Tambah</a>
				</th>
			</tr>
		</tfoot>
	</table>
	...
	<form action="alternatif.php">
		<button class="btn btn-primary" style="float: right;"><i class="right arrow icon"></i>LANJUT</button>
	</form>
