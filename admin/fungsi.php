...
function showTabelPerbandingan($jenis,$kriteria) {
	...
	?>
						<!-- <input type="text" name="bobot<?php echo $urut?>" value="<?php echo $nilai?>" class="form-control" required> -->
						<select name="bobot<?php echo $urut?>" value="<?php echo $nilai?>" class="form-control" required>
							<option value="1">1. Sama pentingnya (Equal Importance)</option>
							<option value="2">2. Sama hingga sedikit lebih penting</option>
							<option value="3">3. Sedikit lebih penting (Slightly more importance)</option>
							<option value="4">4. Sedikit lebih hingga jelas lebih penting</option>
							<option value="5">5. Jelas lebih penting (Materially more importance)</option>
							<option value="6">6. Jelas hingga sangat jelas lebih penting</option>
							<option value="7">7. Sangat jelas lebih penting (Significantly more importance)</option>
							<option value="8">8. Sangat jelas hingga mutlak lebih penting</option>
							<option value="9">9. Mutlak lebih penting (Absolutely more importance)</option>
						</select>
					</div>
				</td>
			</tr>
